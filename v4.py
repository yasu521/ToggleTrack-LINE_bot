...
class TogglClient:
    """改良版Togglクライアント"""
    BASE_URL = "https://api.track.toggl.com/api/v9"  # API用ベースURL
    REPORTS_URL = "https://api.track.toggl.com/reports/api/v2/details"  # レポート用フルURL
    ...
    async def _request(self, method: str, path: str, **kwargs):
        ...
        path が "http" で始まる場合はフルURLとみなし、BASE_URL を連結しない
        """
